...
class TaskDialog(QDialog):
    def __init__(self, data: Dict = {}):
        ...
        self.boldButton.setPopupMode(QToolButton.InstantPopup)
        self.boldButton.setProperty("class", "square-button right-border")
        ...
        self.italicButton.setPopupMode(QToolButton.InstantPopup)
        self.italicButton.setProperty("class", "square-button right-border")
        ...
        self.markdownEditorHeaderLayout.setSpacing(0)
        ...
        self.descriptionEditLayout.setContentsMargins(0, 0, 0, 0)
        self.descriptionEditLayout.setSpacing(0)
